...
import { MeProjectEvaluationService } from '../services/me-project-evaluation.service';
...
import {
  ...
  SMILEYS,
  QuestionDefinition,
} from '../models/me-project-eval-questions';
...
@Component({
  ...
  templateUrl: './me-project-eval-form.component.html',
  styleUrls: ['./me-project-eval-form.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule],
})
export class MeProjectEvaluationFormComponent implements OnInit, OnDestroy {
  // Constant(s)
  static readonly FORM_TYPE = 'ME-PROJECT';
  ...
  constructor(
    ...
    private meEvaluationService: MeProjectEvaluationService,
  ...
  submitEvaluation(): void {
    ...
    const payload: any = {
      ...
      formType: this.formType?.trim() || 'ME-PROJECT', // default to 'ME-PROJECT' if formType is empty
    ...
    this.meEvaluationService.submitEvaluation(payload).subscribe({
      next: (response) => {
