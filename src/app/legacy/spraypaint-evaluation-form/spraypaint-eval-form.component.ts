...
@Component({
  ...
  templateUrl: './spraypaint-eval-form.component.html',
  styleUrls: ['./spraypaint-eval-form.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule],
})
export class SpraypaintEvaluationFormComponent implements OnInit, OnDestroy {
  // Constant(s)
  static readonly FORM_TYPE = 'SPRAYPAINT';
  ...
  constructor(
    ...
    private sEvaluationService: SpraypaintEvaluationService,
  ...
  submitEvaluation(): void {
    ...
    const payload: any = {
      ...
      formType: this.formType?.trim() || 'SPRAYPAINT', // default to 'SPRAYPAINT' if formType is empty
    ...
    this.sEvaluationService.submitEvaluation(payload).subscribe({
      next: (response) => {
