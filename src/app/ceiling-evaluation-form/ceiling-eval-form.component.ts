...
import { CeilingEvaluationService } from '../services/ceiling-evaluation.service';
...
import {
  ...
  SMILEYS,
  QuestionDefinition,
} from '../models/ceiling-eval-questions';
...
@Component({
  ...
  templateUrl: './ceiling-eval-form.component.html',
  styleUrls: ['./ceiling-eval-form.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule],
})
export class CeilingEvaluationFormComponent implements OnInit, OnDestroy {
  // Constant(s)
  static readonly FORM_TYPE = 'CEILING';
  ...
  constructor(
    ...
    private ceilingEvaluationService: CeilingEvaluationService,
  ...
  submitEvaluation(): void {
    ...
    const payload: any = {
      ...
      formType: this.formType?.trim() || 'CEILING', // default to 'CEILING' if formType is empty
    ...
    this.ceilingEvaluationService.submitEvaluation(payload).subscribe({
      next: (response) => {
