...
import { MetalEvaluationService } from '../services/metal-evaluation.service';
...
import {
  ...
  SMILEYS,
  QuestionDefinition,
} from '../models/metal-eval-questions';
...
@Component({
  ...
  templateUrl: './metal-eval-form.component.html',
  styleUrls: ['./metal-eval-form.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule],
})
export class MetalEvaluationFormComponent implements OnInit, OnDestroy {
  // Constant(s)
  static readonly FORM_TYPE = 'METAL';
  ...
  constructor(
    ...
    private mEvaluationService: MetalEvaluationService,
